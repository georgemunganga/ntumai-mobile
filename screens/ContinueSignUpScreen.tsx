      ...
      <View className="flex-1 bg-white">
        ...
        >
          ...
          <View className="items-center px-6 pt-20 pb-8">
            ...
            <View className="mr-24 mb-3">
              ...
              <AppText className="text-primary text-4xl text-left font-bold mb-2">
              ...
              <AppText className="text-primary text-4xl text-left font-bold mb-4">
            ...
            <AppText className="text-gray-500 text-base text-center">
          ...
          <View className="flex-1 px-6">
            ...
            {/* First Name */}
              ...
              <Input
                ...
                errorText={validationErrors.phoneNumber?.[0]}
              />
              {validationErrors.phoneNumber && validationErrors.phoneNumber.length > 0 && (
                <View className="mt-1">
                  {validationErrors.phoneNumber.map((error, index) => (
                    <AppText key={index} className="text-red-500 text-sm">
                      {error}
                    </AppText>
                  ))}
                </View>
            ...
            <View className="mb-6">
              ...
              >
                ...
                <AppText className="text-gray-600 text-sm flex-1">
                  I accept the{' '}
                  <AppText className="text-primary font-semibold">Terms and Conditions</AppText>
                  {' '}and{' '}
                  <AppText className="text-primary font-semibold">Privacy Policy</AppText>
                </AppText>
              </Pressable>
            ...
            <Button
              title={isLoading ? 'Creating Account...' : 'Continue with OTP'}
            ...
            <View className="flex-row items-center mb-8">
              ...
              <AppText className="mx-6 text-gray-400 text-sm font-medium">OR</AppText>
        ...
        <View className="items-center pb-8">
          ...
          <Pressable onPress={() => router.push("/(auth)/Login")}>
            ...
            <AppText className="text-gray-600 text-base text-center">
