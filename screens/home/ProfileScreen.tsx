  ...
  const renderStars = (rating: number) => {
    ...
    return (
      ...
      <View className='flex-row items-center'>
        ...
        <AppText className='text-gray-500 text-sm ml-1'>({rating}/5)</AppText>
  ...
  const renderReview = (review: Review) => (
    ...
    <View key={review.id} className='bg-gray-100 rounded-2xl p-4 mb-3'>
      ...
      <View className='flex-row items-start justify-between mb-3'>
        ...
        <AppText className='text-gray-500 text-sm'>{review.timestamp}</AppText>
      ...
      <AppText className='text-gray-700 text-base mb-3' numberOfLines={3}>
            ...
            >
              ...
              {index === 2 && review.images && review.images.length > 3 && (
                ...
                <View className='absolute inset-0 bg-[#000000a6] bg-opacity-30 items-center justify-center'>
                  ...
                  <AppText className='text-white text-xs font-bold'>10 more</AppText>
      ...
      <View className='flex-row justify-end'>
        ...
        <TouchableOpacity className='border border-gray-300 rounded-full px-4 py-2'>
          ...
          <AppText className='text-gray-600 text-sm'>Reply</AppText>
  ...
  return (
    ...
    <SafeAreaView className='flex-1 bg-white'>
      ...
      <View className='bg-[#0aaf97] px-4 py-3 flex-row items-center'>
        ...
        <AppText className='text-white font-medium text-lg'>Back</AppText>
      ...
      <ScrollView className='flex-1'>
        ...
        <View className='flex-row items-start '>
          ...
          <View className='pl-2 pt-3 pb-6'>
            ...
            <View className='flex-1'>
              ...
              <AppText className='text-black font-bold text-2xl mb-2'>
            ...
            <View className='flex-row items-center space-x-4'>
              ...
              <AppText className='text-gray-500 text-base'>2.68km</AppText>





              <AppText className='text-gray-500 text-base'>19-29 mins</AppText>
        ...
        <View className='px-4 pb-6'>
          ...
          <View className='flex-row items-center justify-between mb-4'>
            ...
            <AppText className='text-black font-bold text-xl'>Reviews</AppText>
            ...
            <TouchableOpacity className='bg-gray-200 rounded-full px-4 py-2 flex-row items-center'>
              ...
              <AppText className='text-gray-600 text-sm mr-2'>{activeFilter}</AppText>
