...
const CreatePromotion = () => {
  ...
  const [promotionType, setPromotionType] = useState<'store' | 'product'>(
    'store'
  );
      ...
      <ScrollView className='flex-1' showsVerticalScrollIndicator={false}>
        ...
        <View className='px-6 mb-6'>
          <View className='flex-row gap-3 rounded-full p-1'>
            <TouchableOpacity
              onPress={() => setPromotionType('store')}
            ...
            >
              <AppText
                className={`text-center font-medium ${
                  promotionType === 'store' ? 'text-white' : 'text-primary'
                }`}
              >
                Store Wide
              </AppText>
            ...
            <TouchableOpacity
              onPress={() => setPromotionType('product')}
              className={`flex-1 py-3 px-6 rounded-full ${
            ...
            >
              <AppText
                className={`text-center font-medium ${
                  promotionType === 'product' ? 'text-white' : 'text-primary'
                }`}
              >
                Product
              </AppText>
          ...
          <View className='bg-[#ededed] rounded-2xl p-6 shadow-sm'>
            <View className='mb-4'>
              ...
              <TouchableOpacity className='flex-row bg-white items-center justify-between rounded-full p-4 border border-gray-200'>
                <View className='flex-row items-center'>
                  ...
                  <AppText className='text-gray-800 ml-3'>
                    {discountType}
                  </AppText>
                </View>
            ...
            <View className='mb-4'>
              ...
              <View className='flex-row bg-white items-center rounded-full py-1 px-2 border border-gray-200'>
                <Ionicons name='logo-usd' size={20} color='#666' />
                <TextInput
                  value={fixedPrice}
