    ...
    <View className="flex-1 bg-white">
      ...
      <View className="px-6 py-4 border-b border-gray-200 flex-row items-center">
        ...
        <View className="flex-1">
          ...
          <AppText className="text-2xl font-bold text-gray-900">Addresses</AppText>





          <AppText className="text-gray-600 text-sm">{addresses.length} saved</AppText>
              ...
              <View className="flex-row items-start flex-1">
                ...
                <View className="flex-1">
                  ...
                  <View className="flex-row items-center mb-1">
                    ...
                    <AppText className="text-lg font-bold text-gray-900 uppercase">
