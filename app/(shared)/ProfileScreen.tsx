          ...
          <View className="gap-3">
            ...
            >
              <View className="flex-row items-center">
                ...
                <Text className="text-gray-900 font-semibold">Addresses</Text>
              </View>
              <Feather name="chevron-right" size={20} color="#9CA3AF" />
            </TouchableOpacity>
          ...
          <View className="gap-4">
            ...
            <View className="flex-row items-center justify-between">
              <View className="flex-row items-center">
                ...
                <Text className="text-gray-900 font-semibold">Location Services</Text>
              </View>
              <Switch
          ...
          <View className="gap-3">
            <TouchableOpacity className="flex-row items-center justify-between py-4 border-b border-gray-100">
              <View className="flex-row items-center">
                ...
                <Text className="text-gray-900 font-semibold">Help & Support</Text>
              </View>
              <Feather name="chevron-right" size={20} color="#9CA3AF" />
            </TouchableOpacity>
            ...
            <TouchableOpacity className="flex-row items-center justify-between py-4 border-b border-gray-100">
              <View className="flex-row items-center">
                ...
                <Text className="text-gray-900 font-semibold">Terms & Privacy</Text>
              </View>
              <Feather name="chevron-right" size={20} color="#9CA3AF" />
            </TouchableOpacity>
