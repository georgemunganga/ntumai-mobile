  ...
  return (
    ...
    <ScrollView className="flex-1 bg-gray-50" showsVerticalScrollIndicator={false}>
      ...
      <View className="bg-white border-b border-gray-200 px-4 py-4">
        ...
        <AppText className="text-2xl font-bold text-gray-900">Top Up Float</AppText>
      ...
      <View className="px-4 py-4">
        ...
        <View className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg p-6 mb-6 text-white">
          ...
          <AppText className="text-white text-sm opacity-90 mb-2">Current Float Balance</AppText>





          <AppText className="text-white text-4xl font-bold mb-4">
          ...
          <View className="flex-row justify-between">
            ...
            <View>
              ...
              <AppText className="text-white text-xs opacity-75">Earnings</AppText>
            ...
            <View>
              ...
              <AppText className="text-white text-xs opacity-75">Minimum Required</AppText>
        ...
        {floatBalance?.floatBalance < floatBalance?.minimumRequired && (
          ...
          <View className="bg-red-50 rounded-lg p-4 mb-6 border border-red-200">
            ...
            <AppText className="text-red-900 font-semibold mb-1">â ï¸ Low Float Balance</AppText>
        ...
        <AppText className="text-lg font-bold text-gray-900 mb-3">Quick Select</AppText>
        ...
        <AppText className="text-lg font-bold text-gray-900 mb-3">Custom Amount</AppText>
        ...
        <AppText className="text-lg font-bold text-gray-900 mb-3">Payment Method</AppText>
        ...
        {getTopUpAmount() && (
          ...
          <View className="bg-gray-100 rounded-lg p-4 mb-6">
            ...
            <View className="flex-row justify-between mb-2">
              ...
              <AppText className="text-gray-600">Amount to Top Up</AppText>
            ...
            <View className="flex-row justify-between">
              ...
              <AppText className="text-gray-600">New Balance</AppText>





              <AppText className="text-gray-900 font-bold">
