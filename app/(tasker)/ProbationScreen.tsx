...
import { View, ScrollView, ActivityIndicator, Alert, Dimensions } from 'react-native';
  ...
  if (!kpis) {
    ...
    return (
      ...
      <View className="flex-1 justify-center items-center bg-white">
        ...
        <AppText className="text-gray-600">No probation data available</AppText>
  ...
  return (
    ...
    <ScrollView className="flex-1 bg-gray-50">
      ...
      <View className="bg-white border-b border-gray-200 px-4 py-4">
        ...
        <AppText className="text-2xl font-bold text-gray-900">Probation Period</AppText>
      ...
      <View className="px-4 py-4">
        ...
        <View className="bg-white rounded-lg p-4 mb-4 border border-gray-200">
          ...
          <AppText className="text-lg font-bold text-gray-900 mb-3">Progress</AppText>
          ...
          <View className="mb-2">
            ...
            <View className="flex-row justify-between items-center mb-2">
              ...
              <AppText className="text-sm text-gray-600">Days Completed</AppText>
        ...
        {alerts.length > 0 && (
          ...
          <View className="bg-red-50 rounded-lg p-4 mb-4 border border-red-200">
            ...
            <AppText className="text-lg font-bold text-red-900 mb-2">â ï¸ Alerts</AppText>
            ...
            {alerts.map((alert, index) => (
              ...
              <AppText key={index} className="text-sm text-red-700 mb-1">
        ...
        <AppText className="text-lg font-bold text-gray-900 mb-3">Key Performance Indicators</AppText>
        ...
        <View className={`rounded-lg p-4 mb-3 border ${getStatusColor(
          ...
          <View className="flex-row justify-between items-start mb-2">
            ...
            <View>
              ...
              <AppText className="text-sm text-gray-600">Acceptance Rate</AppText>





              <AppText className="text-2xl font-bold text-gray-900 mt-1">
            ...
            <AppText className={`text-sm font-semibold ${getStatusTextColor(
        ...
        <View className={`rounded-lg p-4 mb-3 border ${getStatusColor(
          ...
          <View className="flex-row justify-between items-start mb-2">
            ...
            <View>
              ...
              <AppText className="text-sm text-gray-600">On-Time Rate</AppText>
        ...
        <View className={`rounded-lg p-4 mb-3 border ${getStatusColor(
          ...
          <View className="flex-row justify-between items-start mb-2">
            ...
            <View>
              ...
              <AppText className="text-sm text-gray-600">Completion Rate</AppText>
        ...
        <View className={`rounded-lg p-4 mb-3 border ${getStatusColor(
          ...
          <View className="flex-row justify-between items-start mb-2">
            ...
            <View>
              ...
              <AppText className="text-sm text-gray-600">Average Rating</AppText>
        ...
        <View className={`rounded-lg p-4 mb-4 border ${getStatusColor(
          ...
          <View className="flex-row justify-between items-start mb-2">
            ...
            <View>
              ...
              <AppText className="text-sm text-gray-600">Incident Rate</AppText>
        ...
        <View className="bg-blue-50 rounded-lg p-4 border border-blue-200">
          ...
          <AppText className="text-sm text-blue-900 leading-5">





            <AppText className="font-bold">â¹ï¸ Probation Info: </AppText>
